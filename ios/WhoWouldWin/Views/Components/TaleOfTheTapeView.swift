...
struct TaleOfTheTapeView: View {
    ...
    private func head(_ a: Animal, tint: Color) -> some View {
        ...
        .background(Capsule().fill(tint.opacity(0.6))
            .overlay(Capsule().stroke(Kids.ink.opacity(0.5), lineWidth: 1.5)))
    }
        ...
        Text(value)
            ...
            .background(
                RoundedRectangle(cornerRadius: 12, style: .continuous)
                    ...
                    .overlay(RoundedRectangle(cornerRadius: 12, style: .continuous).stroke(Kids.ink.opacity(0.35), lineWidth: 1.5))
            )
    }
}
