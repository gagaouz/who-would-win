import type { AdminOverview, AnimalLeaderboard, RecentBattleRow } from '../services/battleLogger';
import type { getCustomCreatureReport } from '../services/customCreatureLogger';

export interface DashboardData {
  overview: AdminOverview;
  custom: ReturnType<typeof getCustomCreatureReport>;
  animals: AnimalLeaderboard;
  recent: RecentBattleRow[];
}
