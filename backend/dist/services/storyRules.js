...
exports.WHY_RULES = exports.FACT_RULES = exports.SIGNATURE_MOVE_RULE = exports.SOLO_RULE = exports.TONE_RULES = void 0;
exports.TONE_RULES = `Tone — an exciting cartoon action scene for kids aged 6–12 (nature documentary meets Saturday-morning cartoon):\n` +
...
exports.SOLO_RULE = `- ONE-ON-ONE: each side is a single fighter with no help. Never mention packs, pods, herds, prides, swarms, family members or allies helping either fighter.\n`;
exports.SIGNATURE_MOVE_RULE = `- Name AT LEAST ONE specific signature move or ability, e.g. "a thunderous 5-ton hip-check", "a lightning-fast swooping dive", "a famous 600-volt zap", "a horn-first charge".\n`;
exports.FACT_RULES = `- It must be TRUE: real-world biology for real animals, the established legend for mythical ones. Prefer the "verified fact" given in the fighter profiles; otherwise only use well-known facts you are sure of. No invented numbers.\n` +
...
exports.WHY_RULES = `- ONE short sentence (max ~14 words) naming the SPECIFIC real thing that decided it: size, speed, armor, venom, a special ability, or the arena. e.g. "A wolf is thousands of times heavier than a tiny beetle." or "Medusa's stone-turning stare ends the fight in a blink."\n` +
